...
void main() {
  ...
  group('Clear Button Golden Tests', () {
    group('Isolated Clear Button', () {
      testWidgets('renders clear button with gray (#505050) background',
          (WidgetTester tester) async {
        // Build an isolated clear button matching the exact styling
            ...
            home: Scaffold(
              ...
              body: Center(
                child: SizedBox(
                  ...
                  height: 80,
                  child: Container(
                    key: const Key('isolated_clear_button'),
                    decoration: ClearButtonConfig.decoration,
                    child: Center(
                      child: Text(
                        ClearButtonConfig.label,
                        style: ClearButtonConfig.textStyle,
                      ),
                    ),
                  ),
                ),
        ...
        // Capture golden image of isolated clear button
        await expectLater(
          find.byKey(const Key('isolated_clear_button')),
          matchesGoldenFile('clear_button_isolated.png'),
        );
      });
      ...
      testWidgets('verifies button decoration matches gray color specification',
        ...
        await expectLater(
          ...
          matchesGoldenFile('clear_button_color_verification.png'),
        );
      });
      ...
      testWidgets('renders button with correct circular shape',
              ...
              body: Center(
                child: SizedBox(
                  ...
                  child: Container(
                    ...
                    decoration: CalculatorButtonDecorations.clearButton,
                    child: Center(
                      child: Text(
                        ClearButtonConfig.label,
                        style: ClearButtonConfig.textStyle,
        ...
        await expectLater(
          ...
          matchesGoldenFile('clear_button_circular_shape.png'),
        );
      });
    });
    ...
    group('Button in Grid Context', () {
      ...
      testWidgets('renders clear button in calculator grid first row',
          (WidgetTester tester) async {
        ...
        await expectLater(
          ...
          matchesGoldenFile('calculator_grid_with_clear.png'),
        );
      });

      testWidgets('clear button positioned correctly among first row buttons',
          (WidgetTester tester) async {
        await tester.pumpWidget(createCalculatorGridWidget());
        await tester.pumpAndSettle();

        // Find the clear button in the grid
        final clearButton = find.byKey(const Key('clear_button'));
        expect(clearButton, findsOneWidget);

        // Capture golden of the clear button within the grid
        await expectLater(
          clearButton,
          matchesGoldenFile('clear_button_in_grid.png'),
        );
      });
      ...
      testWidgets('first row shows C, (), %, ÷ buttons in correct order',
        ...
        await expectLater(
          find.byType(CalculatorButtonGrid),
          matchesGoldenFile('calculator_first_row_with_clear.png'),
        );
      });
    });
    ...
    group('Button Pressed/Highlight State', () {
      testWidgets('renders button in normal state',
        ...
        await expectLater(
          ...
          matchesGoldenFile('clear_button_normal_state.png'),
        );
      });
      ...
      testWidgets('renders button with slightly lighter color for pressed state simulation',
        ...
        await expectLater(
          ...
          matchesGoldenFile('clear_button_pressed_state.png'),
        );
      });
      ...
      testWidgets('compares normal and pressed states side by side',
        ...
        await expectLater(
          ...
          matchesGoldenFile('clear_button_states_comparison.png'),
        );
      });
    });
    ...
    group('Design Specification Verification', () {
      testWidgets('button background color is exactly #505050',
        ...
        expect(
          CalculatorColors.clearButtonBackground,
          equals(const Color(0xFF505050)),
        );
        expect(
          ClearButtonConfig.backgroundColor,
          equals(const Color(0xFF505050)),
        );
      });
      ...
      testWidgets('renders all design specifications in single golden',
        ...
        await expectLater(
          ...
          matchesGoldenFile('clear_button_design_specs.png'),
        );
      });
    });
  });
